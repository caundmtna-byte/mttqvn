-- Gợi ý: chạy thủ công sau khi đã có dữ liệu mttq_thiet_lap (đủ loại) và ít nhất một var_nhan_vien.
...
BEGIN
  ...
  SELECT id INTO v_cap FROM public.mttq_thiet_lap WHERE loai = 'cap_quan_ly' ORDER BY thu_tu, id LIMIT 1;
  ...
  SELECT id INTO v_cv FROM public.mttq_thiet_lap WHERE loai = 'chuc_vu' ORDER BY thu_tu, id LIMIT 1;
  ...
  INSERT INTO public.mttq_can_bo (
    cap_quan_ly_id, to_chuc_id, ho_ten, ngay_sinh, gioi_tinh, dan_toc_id, ton_giao, dia_chi,
    ...
    v_cap, v_tc, 'Cán bộ mẫu (seed)', '1988-06-01', 'Nam', v_dt, NULL, 'Nghệ An',
