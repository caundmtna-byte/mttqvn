-- ============================================================================
-- Báo cáo công việc — đổi phân quyền từ phòng ban sang đơn vị (don_vi_id).
-- 4 mức (client gửi p_view_all cho Tỉnh / bypass):
--   1) p_view_all = TRUE                          → mọi task
--   2) p_viewer_id = id_nguoi_tao                 → mình tạo
--      OR p_viewer_id = ANY(ids_ho_tro)            → mình hỗ trợ
--      OR p_viewer_id = id_trach_nhiem             → mình trách nhiệm
--      OR p_viewer_don_vi_id = tnv.don_vi_id        → cùng đơn vị (Xã phường)
-- ============================================================================
