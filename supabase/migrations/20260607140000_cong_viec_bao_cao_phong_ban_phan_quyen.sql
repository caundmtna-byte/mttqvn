-- ============================================================================
-- Báo cáo công việc — thêm lọc theo phòng ban (p_viewer_phong_ban_id).
-- Bỏ Tỉnh ra khỏi viewAll client-side; thay bằng OR clause server-side:
--   OR (p_viewer_phong_ban_id IS NOT NULL
--       AND tnv.id_phong_ban IS NOT NULL
--       AND tnv.id_phong_ban = p_viewer_phong_ban_id)
-- Tương đương phân quyền Công việc: Tỉnh lọc theo phòng ban, Xã phường lọc theo đơn vị.
-- ============================================================================
...
GRANT EXECUTE ON FUNCTION public.cong_viec_bao_cao_kpi(
  date, date, bigint[], bigint[], text[], text[], boolean, bigint, bigint, boolean, bigint
) TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.cong_viec_bao_cao_trend(
  date, date, text, bigint[], bigint[], text[], text[], boolean, bigint, bigint, boolean, bigint
) TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.cong_viec_bao_cao_top_trach_nhiem(
  date, date, integer, bigint[], bigint[], text[], text[], boolean, bigint, bigint, boolean, bigint
) TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.cong_viec_bao_cao_filter_options(
  date, date, bigint, bigint, boolean, bigint
) TO authenticated;
