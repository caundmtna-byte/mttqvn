...
const Login: React.FC = () => {
  ...
  return (
    /*
      Bố cục theo cột: khối đăng nhập chiếm phần giữa, dòng bản quyền nằm
      TRONG luồng ở dưới cùng. Trước đây dòng bản quyền để `absolute bottom-6`
      nên không chiếm chỗ — màn hình thấp (điện thoại nhỏ, bàn phím ảo bật lên,
      xoay ngang) là nó đè thẳng lên nút "Đăng nhập".
    */
    <div className="flex min-h-dvh w-full flex-col bg-background p-6 md:p-12">
