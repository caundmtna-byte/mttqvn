...
export const COMMAND_PALETTE_ENTRIES: readonly CommandPaletteEntry[] = [
  ...
  { path: '/an-sinh-xa-hoi/khen-thuong-nha-tai-tro/danh-sach', nameKey: 'page.anSinhXaHoiDashboard.khenThuongNhaTaiTro', groupKey: 'nav.commandPalette.groupAnSinhXaHoi' },
  ...
  { path: '/an-sinh-xa-hoi/vi-nguoi-ngheo/danh-sach', nameKey: 'page.anSinhXaHoiDashboard.viNguoiNgheo', groupKey: 'nav.commandPalette.groupAnSinhXaHoi' },
  { path: '/an-sinh-xa-hoi/thong-tin-ho-ngheo/danh-sach', nameKey: 'page.anSinhXaHoiDashboard.thongTinHoNgheo', groupKey: 'nav.commandPalette.groupAnSinhXaHoi' },
