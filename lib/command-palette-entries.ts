...
export const COMMAND_PALETTE_ENTRIES: readonly CommandPaletteEntry[] = [
  ...
  { path: '/phan-bien-xa-hoi', nameKey: 'nav.phanBienXaHoi', groupKey: 'nav.commandPalette.groupPhanBienXaHoi' },
  { path: '/phan-bien-xa-hoi/thuc-hien-phan-bien-xa-hoi', nameKey: 'page.phanBienXaHoiDashboard.thucHien', groupKey: 'nav.commandPalette.groupPhanBienXaHoi' },
  { path: '/phan-bien-xa-hoi/thiet-lap-danh-muc', nameKey: 'page.phanBienXaHoiDashboard.thietLapDanhMuc', groupKey: 'nav.commandPalette.groupPhanBienXaHoi' },
