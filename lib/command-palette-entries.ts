...
export const COMMAND_PALETTE_ENTRIES: readonly CommandPaletteEntry[] = [
  ...
  { path: '/an-sinh-xa-hoi/kho-cuu-tro/danh-sach-kho', nameKey: 'page.matTranDashboard.reliefWarehouseList', groupKey: 'nav.commandPalette.groupAnSinhXaHoi' },
  { path: '/an-sinh-xa-hoi/kho-cuu-tro/don-vi-cuu-tro', nameKey: 'page.matTranDashboard.reliefSupportUnits', groupKey: 'nav.commandPalette.groupAnSinhXaHoi' },
  { path: '/an-sinh-xa-hoi/kho-cuu-tro/bao-cao-ho-tro', nameKey: 'page.matTranDashboard.reliefSupportReport', groupKey: 'nav.commandPalette.groupAnSinhXaHoi' },
  { path: '/an-sinh-xa-hoi/quy-vi-nguoi-ngheo/so-thu-chi', nameKey: 'page.anSinhXaHoiDashboard.soThuChi', groupKey: 'nav.commandPalette.groupAnSinhXaHoi' },
  { path: '/an-sinh-xa-hoi/quy-vi-nguoi-ngheo/danh-muc-chi-phi', nameKey: 'page.anSinhXaHoiDashboard.danhMucChiPhi', groupKey: 'nav.commandPalette.groupAnSinhXaHoi' },
  { path: '/an-sinh-xa-hoi/quy-vi-nguoi-ngheo/danh-muc-tai-khoan', nameKey: 'page.anSinhXaHoiDashboard.danhMucTaiKhoan', groupKey: 'nav.commandPalette.groupAnSinhXaHoi' },
  { path: '/an-sinh-xa-hoi/quy-vi-nguoi-ngheo/bao-cao-thong-ke', nameKey: 'page.anSinhXaHoiDashboard.baoCaoThongKe', groupKey: 'nav.commandPalette.groupAnSinhXaHoi' },
  { path: '/an-sinh-xa-hoi/quy-cuu-tro/so-thu-chi', nameKey: 'page.anSinhXaHoiDashboard.soThuChi', groupKey: 'nav.commandPalette.groupAnSinhXaHoi' },
  { path: '/an-sinh-xa-hoi/quy-cuu-tro/danh-muc-chi-phi', nameKey: 'page.anSinhXaHoiDashboard.danhMucChiPhi', groupKey: 'nav.commandPalette.groupAnSinhXaHoi' },
  ...
  { path: '/hanh-chinh/quan-ly-tai-san/chi-phi-tai-san', nameKey: 'page.hanhChinhDashboard.chiPhiTaiSan', groupKey: 'nav.commandPalette.groupHanhChinh' },
  { path: '/hanh-chinh/quan-ly-tai-san/thiet-lap-danh-muc', nameKey: 'page.hanhChinhDashboard.thietLapDanhMuc', groupKey: 'nav.commandPalette.groupHanhChinh' },
  { path: '/hanh-chinh/quan-ly-xe/danh-sach-xe', nameKey: 'page.hanhChinhDashboard.danhSachXe', groupKey: 'nav.commandPalette.groupHanhChinh' },
  { path: '/hanh-chinh/quan-ly-xe/lich-su-su-dung', nameKey: 'page.hanhChinhDashboard.lichSuSuDung', groupKey: 'nav.commandPalette.groupHanhChinh' },
  { path: '/hanh-chinh/quan-ly-xe/chi-phi-xe', nameKey: 'page.hanhChinhDashboard.chiPhiXe', groupKey: 'nav.commandPalette.groupHanhChinh' },
  { path: '/hanh-chinh/quan-ly-xe/thiet-lap-danh-muc', nameKey: 'page.hanhChinhDashboard.thietLapDanhMuc', groupKey: 'nav.commandPalette.groupHanhChinh' },
