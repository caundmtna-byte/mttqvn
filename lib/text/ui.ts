...
export const ui = {
  ...
  "shared": {
    ...
    "import": {
      ...
      "writeModeTitle": "Chế độ ghi",
      "writeModeInsert": "Chỉ thêm mới",
      "writeModeInsertHint": "Dòng đã có trong hệ thống sẽ bị bỏ qua.",
      "writeModeUpsert": "Thêm mới và ghi đè",
      "writeModeUpsertHint": "Dòng đã có sẽ được cập nhật theo nội dung trong file.",
      "writeModeUpdate": "Chỉ cập nhật",
      "writeModeUpdateHint": "Không thêm bản ghi mới, chỉ sửa dòng đã có.",
      "matchTitle": "Cột tham chiếu (nhận diện dòng trùng)",
      "matchHint": "Khớp lần lượt theo thứ tự trong danh sách.",
      "matchRequired": "Chọn ít nhất một cột tham chiếu để biết dòng nào là dòng trùng.",
      "matchNotMapped": "Cột tham chiếu chưa được map sang cột trong file: {{columns}}",
      "continueLabel": "Xem trước",
      "previewTitle": "Đối chiếu với dữ liệu đang có",
      "previewCreate": "Sẽ thêm mới",
      "previewUpdate": "Sẽ ghi đè",
      "previewSkip": "Bỏ qua",
      "previewConfirm": "Ghi dữ liệu",
      "previewChecking": "Đang đối chiếu…",
