...
const getRouteConfig = (t: TFunction): Record<string, RouteConfig> => ({
  ...
  '/an-sinh-xa-hoi/kho-cuu-tro/danh-sach-kho': { label: t('breadcrumb.matTranReliefWarehouseList'), parentPath: '/an-sinh-xa-hoi' },
  '/an-sinh-xa-hoi/kho-cuu-tro/don-vi-cuu-tro': { label: t('breadcrumb.matTranReliefSupportUnits'), parentPath: '/an-sinh-xa-hoi' },
  '/an-sinh-xa-hoi/kho-cuu-tro/bao-cao-ho-tro': { label: t('breadcrumb.matTranReliefSupportReport'), parentPath: '/an-sinh-xa-hoi' },
  '/an-sinh-xa-hoi/quy-vi-nguoi-ngheo/so-thu-chi': { label: t('page.anSinhXaHoiDashboard.soThuChi'), parentPath: '/an-sinh-xa-hoi' },
  '/an-sinh-xa-hoi/quy-vi-nguoi-ngheo/danh-muc-chi-phi': { label: t('page.anSinhXaHoiDashboard.danhMucChiPhi'), parentPath: '/an-sinh-xa-hoi' },
  '/an-sinh-xa-hoi/quy-vi-nguoi-ngheo/danh-muc-tai-khoan': { label: t('page.anSinhXaHoiDashboard.danhMucTaiKhoan'), parentPath: '/an-sinh-xa-hoi' },
  '/an-sinh-xa-hoi/quy-vi-nguoi-ngheo/bao-cao-thong-ke': { label: t('page.anSinhXaHoiDashboard.baoCaoThongKe'), parentPath: '/an-sinh-xa-hoi' },
  '/an-sinh-xa-hoi/quy-cuu-tro/so-thu-chi': { label: t('page.anSinhXaHoiDashboard.soThuChi'), parentPath: '/an-sinh-xa-hoi' },
  '/an-sinh-xa-hoi/quy-cuu-tro/danh-muc-chi-phi': { label: t('page.anSinhXaHoiDashboard.danhMucChiPhi'), parentPath: '/an-sinh-xa-hoi' },
  ...
  '/hanh-chinh/quan-ly-tai-san/thiet-lap-danh-muc': { label: t('page.hanhChinhDashboard.thietLapDanhMuc'), parentPath: '/hanh-chinh' },
  '/hanh-chinh/quan-ly-xe/danh-sach-xe': { label: t('page.hanhChinhDashboard.danhSachXe'), parentPath: '/hanh-chinh' },
  '/hanh-chinh/quan-ly-xe/lich-su-su-dung': { label: t('page.hanhChinhDashboard.lichSuSuDung'), parentPath: '/hanh-chinh' },
  '/hanh-chinh/quan-ly-xe/chi-phi-xe': { label: t('page.hanhChinhDashboard.chiPhiXe'), parentPath: '/hanh-chinh' },
  '/hanh-chinh/quan-ly-xe/thiet-lap-danh-muc': { label: t('page.hanhChinhDashboard.thietLapDanhMuc'), parentPath: '/hanh-chinh' },
  ...
  '/an-sinh-xa-hoi': { label: t('breadcrumb.anSinhXaHoi'), parentPath: '/' },
  '/hanh-chinh': { label: t('breadcrumb.hanhChinh'), parentPath: '/' },
  '/dan-toc-ton-giao/tham-hoi/dip-tham-hoi': { label: t('page.danTocTonGiaoDashboard.dipThamHoi'), parentPath: '/dan-toc-ton-giao' },
  ...
  '/dan-toc-ton-giao/thong-tin/thong-ke-to-chuc-ca-nhan': { label: t('page.danTocTonGiaoDashboard.thongKeToChucCaNhan'), parentPath: '/dan-toc-ton-giao' },
