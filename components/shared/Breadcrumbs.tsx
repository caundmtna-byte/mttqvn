...
const getRouteConfig = (t: TFunction): Record<string, RouteConfig> => ({
  ...
  '/an-sinh-xa-hoi/khen-thuong-nha-tai-tro/danh-sach': { label: t('page.anSinhXaHoiDashboard.khenThuongNhaTaiTro'), parentPath: '/an-sinh-xa-hoi' },
  ...
  '/an-sinh-xa-hoi/vi-nguoi-ngheo/danh-sach': { label: t('page.anSinhXaHoiDashboard.viNguoiNgheo'), parentPath: '/an-sinh-xa-hoi' },
  '/an-sinh-xa-hoi/thong-tin-ho-ngheo/danh-sach': { label: t('page.anSinhXaHoiDashboard.thongTinHoNgheo'), parentPath: '/an-sinh-xa-hoi' },
