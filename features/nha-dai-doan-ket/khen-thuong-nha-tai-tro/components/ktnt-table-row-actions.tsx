...
export interface KtntTableRowActionsProps {
...
export function KtntTableRowActions({
  item,
  menuOpenId,
  onMenuOpenChange,
  onEdit,
  onDelete,
  compact = false,
}: KtntTableRowActionsProps) {
  const close = () => onMenuOpenChange(null);
  const canEdit = useCan('edit', 'khenThuongNhaTaiTroList');
  const canDelete = useCan('delete', 'khenThuongNhaTaiTroList');
