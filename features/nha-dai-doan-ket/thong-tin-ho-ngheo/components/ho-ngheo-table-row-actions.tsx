...
export interface HoNgheoTableRowActionsProps {
  item: HoNgheo;
...
export function HoNgheoTableRowActions({
  item,
  menuOpenId,
  onMenuOpenChange,
  onEdit,
  onDelete,
  compact = false,
}: HoNgheoTableRowActionsProps) {
  const close = () => onMenuOpenChange(null);
  const canEdit = useCan('edit', 'hoNgheoList');
  const canDelete = useCan('delete', 'hoNgheoList');
