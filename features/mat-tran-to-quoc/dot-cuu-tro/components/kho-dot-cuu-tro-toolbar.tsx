...
const KhoDotCuuTroToolbar: React.FC<Props> = ({ onPageBack, onAdd, onExport, onDeleteMany }) => {
  ...
  const activeFilterCount = useMemo(() => {
    return (searchTerm ? 1 : 0) + countKhoDotCuuTroColumnSearchActive(filters.columnSearch ?? {});
