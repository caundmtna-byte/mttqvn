const NGUOI_TAO = 'nguoi_tao:var_nhan_vien!mttq_khen_thuong_id_nguoi_tao_fkey(ho_va_ten,ten_tai_khoan)';
...
/** Danh sách: kèm id dòng con để đếm. */
export const MTTQ_KHEN_THUONG_SELECT_LIST = `${BASE_COLS},${NGUOI_TAO},mttq_khen_thuong_ct(id)`;
