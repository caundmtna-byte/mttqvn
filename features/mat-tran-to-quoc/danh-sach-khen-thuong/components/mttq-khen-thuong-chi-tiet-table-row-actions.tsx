...
export interface MttqKhenThuongChiTietTableRowActionsProps {
...
export function MttqKhenThuongChiTietTableRowActions({
  item,
  menuOpenId,
  onMenuOpenChange,
  onEdit,
  onDelete,
  compact = false,
}: MttqKhenThuongChiTietTableRowActionsProps) {
