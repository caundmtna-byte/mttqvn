...
const LuongNgachToolbar: React.FC<Props> = ({ onPageBack, onAdd, onExport, onDeleteMany, tabsSlot }) => {
  ...
  const activeFilterCount = useMemo(() => {
    return (searchTerm ? 1 : 0) + countLuongThietLapNgachColumnSearchActive(filters.columnSearch ?? {});
