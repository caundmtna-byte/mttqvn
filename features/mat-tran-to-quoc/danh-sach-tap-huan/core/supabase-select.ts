 ...
 */
export const MTTQ_LOP_TAP_HUAN_SELECT_LIST = `${BASE_COLS},${NGUOI_TAO},${DON_VI_EMBED},mttq_lop_tap_huan_ct(count)`;
...
export const MTTQ_LOP_TAP_HUAN_SELECT_FULL = `${BASE_COLS},${NGUOI_TAO},${DON_VI_EMBED},${CT_FULL}`;
