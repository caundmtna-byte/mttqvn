const NGUOI_TAO =
  'nguoi_tao:var_nhan_vien!mttq_lop_tap_huan_id_nguoi_tao_fkey(ho_va_ten,ten_tai_khoan)';
...
export const MTTQ_LOP_TAP_HUAN_SELECT_LIST = `${BASE_COLS},${NGUOI_TAO},mttq_lop_tap_huan_ct(id)`;
