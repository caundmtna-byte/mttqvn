...
export interface MttqThietLapRowActionsProps {
  item: MttqThietLap;
...
export function MttqThietLapRowActions({
  item,
  menuOpenId,
  onMenuOpenChange,
  onEdit,
  onDelete,
  compact = false,
}: MttqThietLapRowActionsProps) {
  const close = () => onMenuOpenChange(null);
  const canEdit = useCan('edit', 'matTranThietLapCaiDat');
  const canDelete = useCan('delete', 'matTranThietLapCaiDat');
