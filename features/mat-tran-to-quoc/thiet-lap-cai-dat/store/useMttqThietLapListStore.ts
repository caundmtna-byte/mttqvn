...
import type { MttqThietLapFilters } from '../core/types';
...
const initialFilters: MttqThietLapFilters = { columnSearch: {}, mo_ta_bucket: '' };

export const useMttqThietLapListStore = createGenericStore<MttqThietLapFilters>(initialFilters, DEFAULT_COLUMNS);
