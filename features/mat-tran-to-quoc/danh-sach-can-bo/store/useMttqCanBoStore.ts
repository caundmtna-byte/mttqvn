...
const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'ten_don_vi', label: txt('matTranCanBo.store.donViCol'), visible: true, minWidth: 140, maxWidth: 220, order: 8 },
  { id: 'dien_thoai', label: txt('matTranCanBo.store.dienThoaiCol'), visible: true, minWidth: 108, maxWidth: 132, order: 9 },
  { id: 'dang_vien', label: txt('matTranCanBo.store.dangVienCol'), visible: false, minWidth: 88, maxWidth: 108, order: 10 },
  { id: 'tg_cap_nhat', label: txt('matTranCanBo.store.tgCapNhatCol'), visible: false, ...P.datetime, order: 11 },
];
