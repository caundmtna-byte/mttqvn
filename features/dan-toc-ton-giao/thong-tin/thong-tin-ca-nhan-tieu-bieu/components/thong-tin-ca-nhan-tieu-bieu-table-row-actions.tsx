...
export interface ThongTinCaNhanTieuBieuTableRowActionsProps {
...
export function ThongTinCaNhanTieuBieuTableRowActions({
  item,
  menuOpenId,
  onMenuOpenChange,
  onEdit,
  onDelete,
  compact = false,
}: ThongTinCaNhanTieuBieuTableRowActionsProps) {
