...
import type { PbxhThietLapFilters } from '../core/types';
...
const initialFilters: PbxhThietLapFilters = { columnSearch: {}, mo_ta_bucket: '' };

export const usePbxhThietLapStore = createGenericStore<PbxhThietLapFilters>(initialFilters, DEFAULT_COLUMNS);
